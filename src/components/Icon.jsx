const Icon = ({ name, size=16, color="currentColor" }) => {
  const icons = {
    ...
    arrow_left: <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18"/>,
    tag: <path strokeLinecap="round" strokeLinejoin="round" d="M9.568 3H5.25A2.25 2.25 0 0 0 3 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.595.45a18.634 18.634 0 0 0 6.075-6.075c.422-.815.25-1.897-.45-2.595L12.159 3.659A2.25 2.25 0 0 0 10.568 3z"/>,
    ...
    video: <path strokeLinecap="round" d="m15.75 10.5 4.72-4.72a.75.75 0 0 1 1.28.53v11.38a.75.75 0 0 1-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 0 0 2.25-2.25v-9a2.25 2.25 0 0 0-2.25-2.25h-9A2.25 2.25 0 0 0 2.25 7.5v9a2.25 2.25 0 0 0 2.25 2.25Z"/>,
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="none" viewBox="0 0 24 24" stroke={color} strokeWidth={1.8}>
      {icons[name]}
    </svg>
  );
};
...
const catIcon = (cat) => {
  const map = { Study:"book", Projects:"folder", "Job Hunt":"briefcase", Concepts:"lightbulb", Content:"video", Newsletters:"newspaper", Ideas:"lightbulb", Inbox:"inbox", Today:"sun" };
